...
<html lang="en">
    <head>                        
        <title>Non Conformance Settings</title>            
    ...
    <body>
            ...
            <div class="app-container">
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading app-heading-bordered app-heading-page">                        
                        <div class="title">
                            <h1>Non Conformance Settings</h1> 
                        </div>     
                    </div>
                         ...
                         <div class="col-md-12">
	                      ...
	                      <div class="col-md-12" >  
	                        ...
	                        <div class="col-md-6">
							 	...
							 	<div class="form-group">
	                            <div class="col-md-12"  >
								    <label class="col-md-4 control-label">Permission Area</label>
										 <div class="col-md-8">
										     <select class="s2-select " id="perArea" onchange=" ">
	                            ...
	                            <div class="col-md-12"  >
								    <label class="col-md-4 control-label">Permission Statu</label>
										 <div class="col-md-8">
										     <select class="s2-select " id="perStatu" onchange=" "> 
											  <option value="wr">Read or Write</option> 
                                  ...
                                  <div class="col-md-12" >  
	                                 ...
	                                 <div class="col-md-4"></div> 
	                                  <div class="col-md-4">  
										 ...
										 onclick="addNonConformanceSet()">Add</button>
					                  </div>
                                </div> 
                                </div>
                             </div> 
        ...
        <!-- END IMPORTANT SCRIPTS -->
		 ...
		 <script type="text/javascript" src="custom/nonConformanceSet.js"></script> 
