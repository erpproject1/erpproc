                          ...
                          <div class="block block-condensed">
                           ...
                           <div class="block-content">
                                ...
                                <div class="wizard" id="wizard">
                                  <!--    <ul>
                                        <li>
                                            <a href="#step-1">
                                                ...
                                                <span class="stepDesc">Step 1<br /><small>Personal</small></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#step-2">
                                                <span class="stepNumber">2</span>
                                                <span class="stepDesc">Step 2<br /><small>Contact</small></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#step-3">
                                                <span class="stepNumber">3</span>
                                                <span class="stepDesc">Step 3<br /><small>Education</small></span>                   
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#step-4">
                                                <span class="stepNumber">4</span>
                                                <span class="stepDesc">Step 4<br /><small>Contract</small></span>                   
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#step-5">
                                                <span class="stepNumber">5</span>
                                                <span class="stepDesc">Step 5<br /><small>Training</small></span>                   
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#step-6">
                                                <span class="stepNumber">6</span>
                                                <span class="stepDesc">Step 6<br /><small>Experiences</small></span>                   
                                            </a>
                                        </li>
                                    </ul>
                                    -->
                                    ...
                                    <div id="step-1" >    
                                      <h4 class="text-uppercase text-bold text-rg heading-line-middle">&nbsp;<span>Personal</span></h4>                                        
                                        <div class="row">
                                              ...
                                              <form class="form-horizontal">
												    ...
												    <div class="form-group">
															...
															<div class="col-sm-9 col-md-10 col-lg-10 text-right">
																...
																<button type="button"   onclick="nextt()" class="btn btn-warning btn-sm">Next
																</button>
															</div>
														</div>
                                    ...
                                    <div id="step-2">
                                        <h4 class="text-uppercase text-bold text-rg heading-line-middle">&nbsp;<span>Contact</span></h4>
                                         <div class="row">
													   ...
													   <div class="form-group">
															...
															<div class="col-sm-9 col-md-10 col-lg-10 text-right">
																...
																<button type="button" id="btn2update"  onclick="updatePersonal('contact')" class="btn btn-success btn-sm">Update</button>
																 <button type="button"  onclick="backk()" class="btn btn-warning btn-sm">Previous</button>
																 <button type="button" onclick="nextt()" class="btn btn-warning btn-sm">Next
																</button>
															</div>
														</div>
                                    ...
                                    <div id="step-3">
                                        <h4 class="text-uppercase text-bold text-rg heading-line-middle">&nbsp;<span>Education</span></h4>
                                         <div class="row">
                                    ...
                                    <div id="step-4">
                                        <h4 class="text-uppercase text-bold text-rg heading-line-middle">&nbsp;<span>Contract</span></h4>
                                        <div class="row">
                                              ...
                                              <form class="form-horizontal"> 
													   <div class="form-group">
														...
														<div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select class="bs-select" id="idContDura2"> 
																<option value="0" selected>Select...</option>
														 ...
														 <div class="form-group">                                                                
															...
															<div class="col-md-2" hidden>
																<select class="bs-select" id="idContAnVaDa2">
																<option value="0" selected>Select...</option>
																	<option value="Year">Year</option>
																	<option value="Month">Month</option>
																	<option value="Week">Week</option>
														 ...
														 <div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select class="bs-select" id="idContAnVaPer2">
																<option value="0" selected>Select...</option>
																	<option value="Year">Year</option>
																	<option value="Month">Month</option>
																	<option value="Week">Week</option>
														  ...
														  <div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select class="bs-select" id="idMoney1">                                      
																</select>
															</div>
														 </div>
														 ...
														 <div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select class="bs-select" id="idMoney2">                                    
																</select>
															</div>
														 </div>
														 ...
														 <div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select class="bs-select" id="idMoney3">                                      
																</select>
															</div>
														 </div>
														 ...
														 <div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select class="bs-select" id="idMoney4">                                     
																</select>
															</div>
														 </div>
														...
														<div class="form-group " id="idAllowanceDiv" style="display:none;" > 
															...
															<div class="col-md-2">
																<select class="bs-select" id="idMoney5">                                     
																</select>
															</div>
														 </div>
                                    ...
                                    <div id="step-5">
                                        <h4 class="text-uppercase text-bold text-rg heading-line-middle">&nbsp;<span>Training</span></h4>
                                        <div class="row">
                                              ...
                                              <form class="form-horizontal"> 
												   <div class="form-group">
														...
														<div class="form-group">                                                                
															...
															<div class="col-md-2">
																<select id="validityType" class="bs-select">
																<option value="0" selected>Select...</option>
                                    ...
                                    <div id="step-6">
                                        <h4 class="text-uppercase text-bold text-rg heading-line-middle">&nbsp;<span>Experiences</span></h4>
                                        <div class="row">
											   ...
											   <div class="form-group">
															...
															<div class="col-sm-9 col-md-10 col-lg-10 text-right">
																...
																<button type="button"  id="btn5add" onclick="peAction2()" class="btn btn-success btn-sm">Add </button>
																 <button type="button"  onclick="backk()" class="btn btn-warning btn-sm">Previous</button> 
																 <button type="button" onclick="nextt()" class="btn btn-warning btn-sm">Next </button>
															</div>
														</div>
														 <div class="form-group">                                       
                                 ...
                                 <!-- 
                                <button class="btn btn-success btn-clean" onclick="backk()" id="geri">geri</button>
                                <button class="btn btn-success btn-clean"  onclick="nextt()" id="ileri">ileri</button>
                                 -->
                            </div>                            
      ...
      <!-- IMPORTANT SCRIPTS -->
       ...
       <script type="text/javascript" src="js/vendor/smartwizard/jquery.smartWizard.js"></script>
		...
		<script type="text/javascript" src="custom/personalExperience.js"></script>
		 ...
		 <script type="text/javascript" src="custom/stepperExample.js"></script> 
